...
class CommitmentAndMinContextSlotConfig extends CommitmentConfig {
  ...
  factory CommitmentAndMinContextSlotConfig.fromJson(final Map<String, dynamic> json)
    => _$CommitmentAndMinContextSlotConfigFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$CommitmentAndMinContextSlotConfigToJson(this);
}