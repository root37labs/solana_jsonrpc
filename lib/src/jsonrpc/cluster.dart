...
import 'package:solana_common/models.dart' show Serializable;
...
class Cluster extends Serializable {
  ...
  factory Cluster.fromJson(final Map<String, dynamic> json) => _$ClusterFromJson(json);
  ...
  /// ```
  String? get id => RegExp(r'api.([a-zA-Z]+)[^.]*.solana.com').firstMatch(uri.host)?.group(1);
